...
public class OldPreferencesActivity extends IHWActivity {
	...
	protected void onStart() {
		...
		((EditText)this.findViewById(R.id.edittext_year)).setText("" + year);
		...
		((EditText)this.findViewById(R.id.edittext_year)).addTextChangedListener(new TextWatcher() {
		...
		((Button)this.findViewById(R.id.button_change_year)).setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				int year = Curriculum.getCurrentYear();
				try {
					year = Integer.parseInt(((EditText)findViewById(R.id.edittext_year)).getText().toString());
				} catch (NumberFormatException ignored) {}
				Curriculum.setCurrentYear(year);
				Intent i = new Intent(OldPreferencesActivity.this, ScheduleActivity.class);
		...
		((Button)this.findViewById(R.id.button_redownload)).setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				Intent i = new Intent(OldPreferencesActivity.this, DownloadScheduleActivity.class);
				i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
				startActivity(i);
			}
		});
