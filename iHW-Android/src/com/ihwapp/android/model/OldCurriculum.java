...
/**
 * The OldCurriculum class is the top-level class in the model.
 * It represents one school year of classes and notes.
 */
public class OldCurriculum {
	//TODO base the curriculum on cycles instead of years for the notes.
	private static OldCurriculum currentCurriculum;
	
	public static OldCurriculum getCurrentCurriculum(Context ctx) {
	 ...
	 */
	public static OldCurriculum getCurriculum(Context ctx, int campus, int year) {
	...
	public static boolean loadCurriculum(final Context ctx, final int campus, final int year) {
		...
		if (curriculumJSON == "") {
			...
			//Log.d("iHW", yearJSON);
			currentCurriculum = new OldCurriculum(curriculumJSON, yearJSON);
			return true;
		}
	 ...
	 */
	public OldCurriculum(String curriculumJSON, String yearJSON) {
		try {
